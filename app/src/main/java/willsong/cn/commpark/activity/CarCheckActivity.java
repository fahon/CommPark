...
public class CarCheckActivity extends OBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentViewWithTitle(R.layout.activity_car_check);
        ...
        if(mBusinessManager.getIntentCheckCar().equals("1")){
        ...
        _plateNumberEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CarCheckActivity.this.startActivityForResult(it, 0);
            }
        });
        ...
        car_check_break.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(MemoryCameraActivity.ISCHECKCAR==1){//车辆盘点中,回退到识别界面
                    Intent intent = new Intent(CarCheckActivity.this,MemoryCameraActivity.class);
