...
package willsong.cn.commpark.activity.zxing.camera;
...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		// lrf
		//lrfcameraResolution = getCameraResolution(parameters, screenResolution);
	...
	void setDesiredCameraParameters(Camera camera) {
		...
		setDisplayOrientation(camera, 90);// lrf
	...
	protected void setDisplayOrientation(Camera camera, int angle) {// lrf
