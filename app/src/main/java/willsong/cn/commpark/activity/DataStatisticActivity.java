...
public class DataStatisticActivity extends OBaseActivity implements View.OnClickListener{
    private FrameLayout fl_leaveNum,fl_totalMoney;
    private TextView tv_remainingnum,tv_exitcar_num,tv_exitcar_money,tv_temperary_car,tv_month_car;//在场车辆，已离场，已收费,临时车，月租车
    private RelativeLayout rl_presnetcar;//在场车辆
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentViewWithTitle(R.layout.activity_data_statistic);
        init();
    ...
    private void init(){
        ...
        tv_temperary_car = (TextView) findViewById(R.id.tv_temperary_car);
        tv_month_car = (TextView) findViewById(R.id.tv_month_car);
        ...
        setTitleRightButtonOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyTools.showToastShort(true,"您点击了打印按钮",DataStatisticActivity.this);
            }
        });
    }
    @Override
    public void onClick(final View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_presnetcar:
                final Intent intent3 = new Intent(getApplicationContext(), PresentCarActivity.class);
...
//            MyTools.showToastShort(true, map+"", mContext);
            ...
            Double temperary_car = (Double)map.get("LCount");
            Double month_car = (Double)map.get("YCount");
            tv_exitcar_money.setText(totalAmount);
            tv_temperary_car.setText("临时车:"+temperary_car.intValue()+"辆");
            tv_month_car.setText("月租车:"+month_car.intValue()+"辆");
