...
public class PresentBikeAdapter extends BaseAdapter {
	private ArrayList<Map<String, Object>> map;
	private Context mcontext;

	public PresentBikeAdapter(ArrayList<Map<String, Object>> map, Context mcontext) {
		this.map = map;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mcontext).inflate(
					R.layout.present_bike_item, null);
		...
		try{
			...
			holder.tv_enterTime.setText("租车时间:"+enterTime.substring(5));
